...
A production-ready, multi-tenant SaaS e-commerce platform built with Laravel 11 and Vue.js 3.
...
```bash
# The Node container automatically installs dependencies and starts the dev server
